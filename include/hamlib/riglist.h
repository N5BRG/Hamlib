 ...
 * sdrangel
*/
#define RIG_SDRANGEL 34
#define RIG_BACKEND_SDRANGEL "sdrangel"
#define RIG_MODEL_SDRANGEL_PLUTO RIG_MAKE_MODEL(RIG_SDRANGEL, 1)
#define RIG_MODEL_SDRANGEL_HACKRF RIG_MAKE_MODEL(RIG_SDRANGEL, 2)
#define RIG_MODEL_SDRANGEL_RTLSDR RIG_MAKE_MODEL(RIG_SDRANGEL, 3)
